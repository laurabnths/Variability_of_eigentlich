...
mean(DF2[DF2$syllable_count == '3', 'Speak_duration_of_B']) # mean duration of trisyllabic forms
mean(DF2[DF2$syllable_count == '2', 'Speak_duration_of_B']) # mean duration of disyllabic forms
mean(DF2[DF2$syllable_count == '1', 'Speak_duration_of_B']) # mean duration of monosyllabic forms
...
###################################################################################################
###################################################################################################
# Pre-Processing for DF2 (turning A1_copy.csv into Df2.csv)

setwd("~/Desktop/KEC/Korrigiert")
DF2 = read.csv('A1_copy.csv', stringsAsFactors = FALSE)


DF2 = DF2[DF2$Speak_duration_of_B<0.8,]
DF2$Difference_count = 8-DF2$Count_phonemes_eig

table(DF2$Word_A1 == '<P>')
DF2$Pause_A1 = DF2$Word_A1 == '<P>'
DF2$Pause_C1 = DF2$Word_C1 == '<P>'
DF2$Speaker = str_sub(DF2$Textgrid, start=15, end = 17)
DF2$l.P_B_gvn_A1 = log(DF2$Pr_B.variation._given_A1)
DF2$l.P_B_gvn_C1 = log(DF2$Pr_B.variation._given_C1)

#### True/False into TRUE/FALSE
DF2$LS_in_Vari. = DF2$LS_in_Vari.== 'True'
DF2$LS_frontvowel = DF2$LS_frontvowel == 'True'
DF2$LS_centralvowel = DF2$LS_centralvowel == 'True'
DF2$LS_backvowel = DF2$LS_backvowel == 'True'
DF2$LS_voiced = DF2$LS_voiced == 'True'
DF2$LS_voiceless = DF2$LS_voiceless == 'True'
DF2$LS_plosive = DF2$LS_plosive == 'True'
DF2$LS_nasal = DF2$LS_nasal == 'True'
DF2$LS_fricative = DF2$LS_fricative == 'True'
DF2$LS_lateral = DF2$LS_lateral == 'True'
DF2$LS_trill = DF2$LS_trill == 'True'
DF2$LS_approximant = DF2$LS_approximant == 'True'
DF2$FS_in_Vari. = DF2$FS_in_Vari.=='True' 
DF2$FS_frontvowel = DF2$FS_frontvowel == 'True'
DF2$FS_centralvowel = DF2$FS_centralvowel == 'True'
DF2$FS_backvowel = DF2$FS_backvowel == 'True'
DF2$FS_voiced = DF2$FS_voiced == 'True'
DF2$FS_voiceless = DF2$FS_voiceless == 'True'
DF2$FS_plosive = DF2$FS_plosive == 'True'
DF2$FS_nasal = DF2$FS_nasal == 'True'
DF2$FS_fricative = DF2$FS_fricative == 'True'
DF2$FS_lateral = DF2$FS_lateral == 'True'
DF2$FS_trill = DF2$FS_trill == 'True'
DF2$FS_approximant = DF2$FS_approximant == 'True'

write.csv(DF2, "~/Desktop/KEC/Korrigiert//DF2.csv", row.names=TRUE)
